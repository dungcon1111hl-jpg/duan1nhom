                    ...
                    <form action="index.php?act=dichvu-update" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="so_luong" class="form-control" value="<?= $dichvu['so_luong'] ?>" min="1" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-bold">Đơn giá (VNĐ)</label>
                                <input type="number" name="don_gia" class="form-control" value="<?= (int)$dichvu['don_gia'] ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <a href="index.php?act=dichvu-list&booking_id=<?= $dichvu['booking_id'] ?>" class="btn btn-secondary">Hủy</a>
                        </div>
                    </form>
                </div>
            </div>
